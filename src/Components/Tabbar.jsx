...
function Tabbar() {
 ...
 const{logout}=useAuth()
  return (
        <div className="w-full md:hidden p-1 flex items-center place-content-center text-green-600 h-[70px] pt-2 pb-[env(safe-area-inset-bottom)] fixed z-50 bottom-0 right-0 left-0  ">
