...
function Ourtopchef() {
  return (
    <>
    <div className='w-full text-white grid gap-5 grid-cols-1 md:grid-cols-3'>
    
    {topchef.map((a)=>(
        <div className='flex  border-2 border-white h-[100px] ' 
    ...
    <p>{a.reciepe}</p>
    <p>{a.cusions}</p>
    <div className='w-full flex'><FaFacebook/><FaInstagram/></div>
    </div>
    </div>
       )) }
    </div>
