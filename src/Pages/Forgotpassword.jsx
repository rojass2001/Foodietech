...
function Forgotpassword() {
  ...
  return (
     <Form className='w-full pt-10 bg-black md:bg-gray-900 min-h-screen  flex items-center place-content-center'>
         <div className='w-full md:w-[50%] flex flex-col gap-12 px-10 py-20 items-center 
           ...
           <button type="button" onClick={resetemail} className='w-[70%] md:w-[50%] text-white rounded-full font-bold bg-green-500 p-2'>Send link</button>
